...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        dog = apply_filters(faces_keypoints, image_copy_3, "dog.png")
        custom3 = apply_filters(faces_keypoints, image_copy_4, "custom3.png")

        # Screen with the filter
        cv2.imshow('Screen with bear filter', bear)
        cv2.imshow('Screen with cat filter', cat)
        cv2.imshow('Screen with dog filter', dog)
        cv2.imshow('Screen with rat filter', custom3)
